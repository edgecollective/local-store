...
app.post("/api/user/", (req, res, next) => {
   ...
   var alt = 2.;
	...
	var sql = 'INSERT INTO user (dateTime,vwc,temp,permit,bulk,pore,batt,deviceName,devEUI,rssi) VALUES (?,?,?,?,?,?,?,?,?,?)'
	...
	var params =[ts,data.vwc,data.temp,data.permit,data.bulk,data.pore,data.batt,data.deviceName,data.devEUI,data.rssi]
